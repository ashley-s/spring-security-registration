...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, approvePrivilege));
        ...
        createUserIfNotFound("manager@test.com", "Manager1", "Manager2", "test", new ArrayList<>(Arrays.asList(managerRole)));
